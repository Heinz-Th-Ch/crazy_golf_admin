...
/**
 * <p>Java-Klasse für serverSessionStates complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="serverSessionStates"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "serverSessionStates", propOrder = {
    "listSize"
})
public class ServerSessionStates {
