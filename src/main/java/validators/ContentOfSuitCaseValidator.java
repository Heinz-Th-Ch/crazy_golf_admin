 ...
 */
public class ContentOfSuitCaseValidator implements Validator<ContentOfSuitCaseImpl> {
     ...
     */
    @Override
    public Pair<ValidatorErrorCodes, ValidatorErrorFields> validate(ContentOfSuitCaseImpl testableData) {
