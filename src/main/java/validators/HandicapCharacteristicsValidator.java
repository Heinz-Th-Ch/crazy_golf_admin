 ...
 */
public class HandicapCharacteristicsValidator implements Validator<HandicapCharacteristicsImpl> {
     ...
     */
    @Override
    public Pair<ValidatorErrorCodes, ValidatorErrorFields> validate(HandicapCharacteristicsImpl testableData) {
