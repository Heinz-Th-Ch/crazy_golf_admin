...
/**
 * This class is used to transport several data of the server sessions.<br>
 ...
 * </p>
 */
public class ServerSessionStatesData implements Serializable {

    private final String NEW_LINE = "\n";

    private final Integer listSize;

    public ServerSessionStatesData(Integer listSize) {
    ...
    public String toXmlString() {
        StringBuffer result = new StringBuffer(String.format("<serverSessionStatesData>%s", NEW_LINE));

        result.append(String.format("<listSize>%s</listSize>%s", getListSize(), NEW_LINE));

        result.append(String.format("</serverSessionStatesData>%s", NEW_LINE));
