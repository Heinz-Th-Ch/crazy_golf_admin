 ...
 */
public class SingleTryPdfExporter {
    private final static String DEST = "testData/SingleTryPdfExporter/SingleTryPdfExporter.pdf";
    ...
    public static void main(String[] args) throws Exception {
        ...
        new SingleTryPdfExporter().manipulatePdf(DEST);
    }
